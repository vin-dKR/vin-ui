...
Welcome to our UI library! This guide will walk you through the installation process and help you get started.
...
The button component allows users to take actions with a single click.
...
```bash
npm install @your-ui-library/button
```
